...
<html lang="en">
  ...
  <section id="container" >
    ...
    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
      ...
      <form class="form-horizontal" id="register" style="height: 350px" method="post" action="<?php echo base_url()?>students/update_password">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control div" pattern=".{6,}" title="6 karakter/lebih" name="retype_new_password" type="password" required>
          </div>
        </div>
        <div class="form-group">
