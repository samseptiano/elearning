...
<html lang="en">
  <head>
    ...
    <title>Elearning Galileo | Daftar Nilai Siswa</title>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row" style="background-color: #ffffff;opacity: 0.8;box-shadow: 5px 5px 10px #888888;border-radius:5px;margin: 10px 2px 15px 2px">
                  <div class="col-lg-12 main-chart">
                  <div id="infoMessage" style="color:red" ><?php echo $this->session->flashdata('msg');?></div>      
						              			  <!--  PROFILE SECTION-->

                    <div class="row">
                       <div class="col-md-12" style="overflow: scroll;height:480px">
            <table class="table data">
                ...
                <tbody id="absen">
                    <tr class="active">
                        ...
                        <td>
                            <a href="<?php echo base_url()?>teachers/score_list_detail/<?php echo $u->id_soal."/".$u->jurusan ?>">Lihat</a>
                        </td>
                    </tr>
                </tbody>
                <?php } ?>
