              ...
              <div class="row">     
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                      ...
                      <?php foreach($tutor as $u){ ?>
                        <img src="<?php echo base_url().$u->foto ?>" class="avatar img-circle img-thumbnail" alt="avatar">
                      </div>
                    </div>
                    ...
                    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                      ...
                      <input name="id_siswa" value="<?php echo $u->id_tutor ?>" type="hidden">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-8">
                            <h4 class="col-lg-8 control-label"><?php echo $u->kelas ?></h4>
                          </div>
                        </div>
                        <div class="form-group">
                          <h4 class="col-lg-3 control-label">Bidang:</h4>
                          <div class="col-lg-8">
                            <h4 class="col-lg-8 control-label"><?php echo $u->bidang ?></h4>
                          </div>
                        </div>
                        <div class="form-group">
