  ...
  <section id="container" >
              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">      
                    ...
                    <br><br>
                      ...
                      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal">Lihat Pengumuman</button>
                      <!-- Modal -->
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            text: 'Jika anda masuk pertama kali, silahkan lihat <a href="#" target="" style="color:#67ce44">Panduan</a>.  Jika tidak, abaikan pesan ini.',
